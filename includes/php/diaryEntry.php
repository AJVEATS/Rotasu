<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $diary_entry_create = "INSERT INTO user_entries_tbl(user_id, entry_time, entry_day, am_entry, pm_entry, diary_entry) VALUES ('$userID', '$entryDateTime', '$entryDay', '$amEntry', '$pmEntry', '$diaryEntry');";
