...
if ($_SERVER["REQUEST_METHOD"] == "POST") { // Checks if a user has submitted a form with a POST request method
    ...
    $username = mysqli_real_escape_string($connection,$_POST['email']); // Gets the user's username that they entered in the login form from index.php
    ...
    // Echo statment for testing values
    echo $username;
